...
exports.CONTENT_URL = exports.NEWS_URL = void 0; // const ajax: XMLHttpRequest = new XMLHttpRequest();
...
function (_super) {
  ...
  function NewsFeedView(containerId) {
    var _this = _super.call(this, containerId, template) || this; // class를 만들어 줬으면 인스턴스를 꼭 만들어줘야 한다.
...
router.addRoutePath('/show/', newsDetailView); // reoter 실행
